                                ...
                                <table class="table table-detail table-bordered mt-4">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <span>{{ number_format($move_invoice_5->total_amount) }}</span>
                                            </td>
                                ...
                                <script>
                                  ...
                                  <div id="pay_or" class="showMoveOut" style="padding: 15px 2px;">
                                    <div class="mt-3" id="pay1" style="display: none;">
                                                ...
                                                <div class="flex-grow-1 ms-3 g-3 row">
                                                    <b class="text-black">รูปแบบการชำระเงิน</b> <br>
                                                            <div class="col-sm-11">
                                                                ...
                                                                @if (count($$move_invoice->receipt) == 0)
                                                                checked    
                                                                @else
                                                                disabled
                                                                @endif
                                                            ...
                                                            >
                                                                ...
                                                                <div class="mb-3" style="border: 1px solid #dbdade;padding: 15px 2px;">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <b class="text-black">รายละเอียดหัวบิล</b> <br>
                                                                            {{ $$move_invoice->room_for_rent->renter->prefix.' '.$$move_invoice->room_for_rent->renter->name.' '.$$move_invoice->room_for_rent->renter->surname }} <br>
                                                                            เลขประจำตัวผู้เสียภาษี {{ $$move_invoice->room_for_rent->renter->id_card_number }} <br>
                                                                            โทร {{ $$move_invoice->room_for_rent->renter->phone }}
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <table class="table table-bordered" id="discount-table2" >
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>
                                                                                <input name="payment_list[title][]" type="text" class="form-control payment_list_title" value="แบ่งจ่ายค่าห้อง {{ $$move_invoice->room_for_rent->room->name }}" placeholder="หัวข้อรายการ">
                                                                            </td>
                                                                            <td class="text-end">
                                            ...
                                            <div class="d-flex">
                                                <div class="flex-grow-1 ms-3 g-3 row">
                                                    ...
                                                    <div class="col-sm-11 mt-2">
                                                        <b id="totalpayfull">ยอดชำระเงินทั้งหมด&nbsp; <span class="total-price">{{ number_format($move_invoice->room_for_rent->room->rent + $move_invoice->water_amount+$move_invoice->electricity_amount) }}</span> &nbsp;บาท</b>
                                        ...
                                        <h4 class="text-center text-danger">ยอดค้างชำระเงินทั้งหมด&nbsp; <span class="">{{ number_format($move_invoice->total_amount - $move_invoice->receipt->pluck('payment_list')->flatten()->sum('price')) }}</span> &nbsp;บาท
                                ...
                                <table class="table table-bordered mt-4 table-detail">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <label class="btn btn-xs btn-label-info waves-effect text-black px-2 custom-file-upload">
                                ...
                                <div class="row g-2 pt-1">
                                    <div class="p-2">
                                        <label class="mb-1 text-black"><i class="ti ti-license text-main mb-1"></i> รายละเอียดหัวบิล</label>
                                            <select name="ref_renter_id" id="select2RenterMove" class="select2 form-select form-select-lg" onchange="get_room_rental_contract(this.value)" required>
