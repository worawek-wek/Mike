                                            ...
                                            newRow.innerHTML = `
                                                ...
                                                <td class="text-end">
                                                    <div style="display: flex; align-items: center; gap: 10px;">
                                                        <input name="payment_list_p[price][]" type="number" class="form-control calculate_3 add_expenses3_price price_increase" oninput="calculate_3Price()" placeholder="จำนวนเงิน" required style="flex: 1;" autocomplete=off />
