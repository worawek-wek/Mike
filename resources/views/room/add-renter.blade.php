...
<script>
    flatpickr('#add_birthdate', { dateFormat: 'd/m/Y', allowInput: true, static: true, disableMobile: true });
    flatpickr('#bs-datepicker-format2', { dateFormat: 'd/m/Y', allowInput: true });
</script>