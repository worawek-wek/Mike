...
@endphp
                ...
                <tbody>
                    @forelse ($invoice?->payment_list ?? [] as $key => $payment_list_item_4)
                        <tr {{ $payment_list_item_4->discount == 1 ? "class=bg-lob" : "" ; }}>
                            ...
                            <td class="text-end gap-1">
                                <div class="d-flex">
                                    <input type="number" name="payment_list[price][]" class="form-control me-2 {{ $payment_list_item_4->discount == 1 ? "price_increase" : "discount-value" ; }} calculate_2" value="{{ $payment_list_item_4->price }}" placeholder="จำนวนเงิน" max="" oninput="calculate_2Price()" required>
                    ...
                    @empty
                        <tr>
                            ...
                            <td class="text-end">
                                <input type="number" name="payment_list[price][]" class="form-control discount-value calculate_2" value="" placeholder="จำนวนเงิน" max="" oninput="calculate_2Price()" required>
        ...
        @if($permission_bill_edit)
            ...
            <button 
                    style="padding-right: 14px;padding-left: 14px;"
                    class="btn btn-sm buttons-collection btn-success waves-effect waves-light me-2"
                    tabindex="0" aria-controls="DataTables_Table_0"
