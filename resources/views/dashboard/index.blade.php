...
<body>
                                ...
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <li class="d-flex mb-3">
                                                ...
                                                <div
                                                    ...
                                                    <div class="user-progress">
                                                        <h6 class="text-light-success mb-0">{{ number_format($summary_month['all_receipt_on_time']) }} บาท</h6>
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="d-flex mb-3">
                                                ...
                                                <div
                                                    ...
                                                    <div class="user-progress">
                                                        <h6 class="text-light-success mb-0">{{ number_format($summary_month['all_receipt_late_with_appointment']) }} บาท</h6>
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="d-flex mb-3">
                                                ...
                                                <div
                                                    ...
                                                    <div class="user-progress">
                                                        <h6 class="text-light-success mb-0">{{ number_format($summary_month['all_receipt_late']) }} บาท</h6>
                                                    </div>
                                                </div>
                                            </li>
                                        </ul>
                                        ...
                                        <div
                                            ...
                                            <h6 class="text-danger text-end">รวมเป็นเงิน {{ number_format($summary['overdue_this_month'] < 0 ? 0 : $summary['overdue_this_month']) }} บาท</h6>
                                        </div>
    ...
    <script>
        ...
        function onYearChange(selectElement) {
            ...
            // โหลดข้อมูลใหม่
            loadData("{{ $page_url }}/monthly-rent-income");
        }

        // ตัวแปร global
        var searchData = {};
        var page = "{{$page_url}}/monthly-rent-income";
