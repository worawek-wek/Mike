...
class NotificateController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['page_url'] = 'notificate';
        $data['page'] = 'สรุปการแจ้ง';
        $data['room'] = Room::whereHas('floor.building', function ($query) {
                                    $query->where('ref_branch_id', session("branch_id"));
                                })->get();
        // $data['title'] = 'Profile';
        
        return view('notificate/index', $data);
    }
    ...
    public function profile($id = null)
    {
        ...
        $data['page_url'] = 'notificate';
        $data['title'] = 'Profile';
        $data['notificate'] = $user;
        
        return view('notificate/profile', $data);
    }
    ...
    public function datatable(Request $request)
    {
        ...
        return view('notificate/table', $data);
    }
    /**
    ...
    public function create()
    {
        ...
        $data['action'] = route('notificate.store');
        $data['notificate'] = [
                            'leave_just_id' => ["1","2","3","9"],
                            'leave_id_number' => ["1"=>"6","2"=>"30","3"=>"6","9"=>"10"]
                        ];
        // return $data['notificate'];
        return view('notificate/form', $data);
        //
    }
     ...
     */
     ...
     public function edit($id)
     {
        $data['page_url'] = 'notificate';
        $data['position'] = Position::get();
        $data['notificate'] = CreditRenter::find($id);
        return view('notificate/view', $data);
     }
